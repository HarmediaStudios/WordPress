...
function wp_smtp_page(){
	...
	if(isset($_POST['wp_smtp_update']) && isset($_POST['wp_smtp_nonce_update'])){
		...
		$wsOptions["fromname"] = htmlentities(trim($_POST['wp_smtp_fromname']));
...
<table class="form-table">
	...
	<tr valign="top">
		...
		<td>
			<label>
				<input type="text" name="wp_smtp_fromname" value="<?php echo stripslashes($wsOptions["fromname"]); ?>" size="43" style="width:272px;height:24px;" />
			</label>
		</td>
	</tr>
	<tr valign="top">
