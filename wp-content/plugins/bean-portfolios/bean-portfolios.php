...
/*
Plugin Name: Bean Portfolio Post Type
...
class Bean_Portfolio_Post_Type {
	...
	function portfolio_init() {
		...
		$taxonomy_portfolio_tag_labels = array(
			...
			'menu_name' 					=> __( 'Portfolio Tags', 'bean' )
		);
	...
	function bean_print_sort_scripts() {
	    ...
	    wp_enqueue_script( 'bean_portfolio_sort', plugins_url( '/js/bean_sort.js', __FILE__ ), array('jquery') );
	...
	<style type="text/css" media="screen">
		 #adminmenu #menu-posts-portfolio div.wp-menu-image{
		 	background:transparent url(<?php echo plugin_dir_url( __FILE__ ); ?>images/icon-portfolio.png) no-repeat 6px -17px !important;    
		 	}
		 ...
		 #adminmenu #menu-posts-portfolio.wp-has-current-submenu div.wp-menu-image {
		 	background:transparent url(<?php echo plugin_dir_url( __FILE__ ); ?>images/icon-portfolio.png) no-repeat 6px 7px !important;
		 	} 
		 
		 @media all and (-webkit-min-device-pixel-ratio: 1.5) {
		 	#adminmenu #menu-posts-portfolio div.wp-menu-image{
		 		background:transparent url(<?php echo plugin_dir_url( __FILE__ ); ?>images/icon-portfolio@2x.png) no-repeat 6px -17px !important; 
		 		background-size: 16px 40px!important;   
		 		}
		 	#adminmenu #menu-posts-portfolio:hover div.wp-menu-image,
		 	#adminmenu #menu-posts-portfolio.wp-has-current-submenu div.wp-menu-image {
		 		background:transparent url(<?php echo plugin_dir_url( __FILE__ ); ?>images/icon-portfolio@2x.png) no-repeat 6px 7px !important;
		 		background-size: 16px 40px!important;  
		 		}     
		 }
	</style>
